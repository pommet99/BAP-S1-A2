<?php die('ici'); ?>
sdkhbvkhdsbvjsdvbjksvbksbvjksvbksdjvbdkvjbsdk
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?php echo get_template_directory(); ?>/photos/baby.jpg" class="d-block w-100" alt="image enfant-maman">
        </div>
        <div class="carousel-item">
            <img src="<?php echo get_template_directory_uri(); ?>/photos/baby2.jpg" class="d-block w-100" alt="image enfant-maman">
        </div>
        <div class="carousel-item">
            <img src="<?php echo get_template_directory_uri(); ?>/photos/baby3.jpg" class="d-block w-100" alt="image enfant-maman">
        </div>
    </div>
